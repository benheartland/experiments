		...
		instrumentInstance.note.forEach(function(noteInstance, noteNumber) {
			...
			step.forEach(function(stepInstance,stepIndex) {
				...
				gridBodyNoteStep.onclick = function() {
					toggleNoteOn(stepIndex, instrumentIndex, noteNumber);
				}
...
function toggleNoteOn(stepNumber, instrumentIndex, noteNumber) {
	if (!unsetNoteOn(stepNumber, instrumentIndex, noteNumber)) {
		setNoteOn(stepNumber, instrumentIndex, noteNumber);
	}
}
...
function unsetNoteOn(stepNumber, instrumentIndex, noteNumber) {
